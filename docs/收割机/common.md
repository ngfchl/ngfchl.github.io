...
​	![image-20241126203645085](https://img.ptools.fun/blog/image-20241126203645085.png)
...
2. 访问个人页面=> 点击发布种子
   ...
   ![image-20250619102142259](https://img.ptools.fun/blog/image-20250619102142259.png)	

3. 在开发者工具=>网络，里面找到getusertorrentlistajax.php，点击，在右侧找到响应
   ![](https://img.ptools.fun/blog/image-20250619102220783.png)

4. 如果你懂 xpath，直接提取发种数，不懂的可以拷贝所有内容发给我处理

   ![](https://img.ptools.fun/blog/image-20250619102327955.png)	
...
![](https://img.ptools.fun/blog/image-20250619101825317.png)	
...
## 更新站点数据报错：`Invalid scheme component`

![image-20250510105321751](https://img.ptools.fun/blog/image-20250510105321751.png)
...
![image-20250430234059564](https://img.ptools.fun/blog/image-20250430234059564.png)
...
![image-20250419211000196](https://img.ptools.fun/blog/image-20250419211000196.png)
...
## 下载器 本次获取辅种数据，共31条辅种数据，耗时35.23秒。当前下载器:tr下载器 本次辅种成功推送195个种子，失败84个种子，等待校验的种子数量:1，本次辅种校验种子22个，
...
[百度ocr获取方式](https://ptools.fun/zh/通用教程/baidu-ocr)
...
![image-20241206093617926](https://img.ptools.fun/blog/image-20241206093617926.png)

## APP一直报404错误

![image-20241206092646587](https://img.ptools.fun/blog/image-20241206092646587.png)

APP 端报 404 错误多数是服务未能正常启动导致的，这是我们可以检查 django 的服务日志

![image-20241206092931410](https://img.ptools.fun/blog/image-20241206092931410.png)
...
​	![image-20241206093407627](https://img.ptools.fun/blog/image-20241206093407627.png)
