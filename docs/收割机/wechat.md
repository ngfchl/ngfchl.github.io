...
![微信机器人扫码登录](/images/app/界面/微信机器人扫码登录.png)
...
4. 进入应用管理。
   ...
   ![img.png](/images/wechat/企微/img.png)
...
1. 点击进入应用后，可以看到应用简介，在这里拿到应用 ID 和 Secret，留存备用。
   ...
   ![img_1.png](/images/wechat/企微/img_1.png)

   Secret 因为安全原因会发到企业微信客户端查看。

   ![img_2.png](/images/wechat/企微/img_2.png)

   ![img_3.png](/images/wechat/企微/img_3.png)
...
3. 找到接收消息 -> 配置 API 接收。
   ...
   ![img_4.png](/images/wechat/企微/img_4.png)

4. 在新界面填入回调地址，并随机生成 Token 与 EncodingAESKey。

   ![img_5.png](/images/wechat/企微/img_5.png)
...
5. 在收割机中填入企业微信相关信息。
   ...
   ![img_6.png](/images/wechat/企微/img_6.png)

6. 收割机中配置好企业微信相关信息后，在网页中点击保存。

   ![img_7.png](/images/wechat/企微/img_7.png)

### 4.4 回调使用

1. 更新菜单：第一次配置菜单，直接在企业微信 APP 中发送消息 `更新菜单` 即可，后续可在菜单中选择更新菜单。

   ![img_8.png](/images/wechat/企微/img_8.png)

   ![img_9.png](/images/wechat/企微/img_9.png)

2. 发送邀请：非试用用户可以邀请他人试用收割机，每个月可以邀请三个邮箱，每个邮箱只能被邀请一次，在应用中直接发送电子邮箱地址即可触发邀请。

   ![img_10.png](/images/wechat/企微/img_10.png)
