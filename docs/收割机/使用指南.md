...
​		![](https://img.ptools.fun/blog/image-20250617200629175.png)	
...
>  安全 Token（目前还叫油猴 Token，后期升级会修改名称为安全 Token） 是接口访问工具使用的验证密码，请妥善保存，这个 Token 会用在油猴脚本、收割机浏览器插件，以及企业微信验证。
>  ​	
>  ​	添加方法：在 APP 中打开系统设置，并添加油猴 Token，后期会改为安全Token，可以自定义，也可以使用随机按钮生成 Token，没有此选项的请点击右下角➕添加
>  ​	
>  ​	![](https://img.ptools.fun/blog/image-20241020085907647.png)

### c. 添加OCR文字识别服务【空和皇后签到使用】

1. 申请刚百度 OCR 免费服务：[教程地址](/zh/通用教程/baidu-ocr)
...
![](https://img.ptools.fun/blog/image-20250617202153728.png)
...
1. 在部署docker时映射下载器种子文件夹
   ...
   ![image-20241126203608825](https://img.ptools.fun/blog/image-20241126203608825.png)	
...
3. 添加辅种计划任务
   ...
   ![image-20241126203706655](https://img.ptools.fun/blog/image-20241126203706655.png)	
...
1. 去要订阅的网站生成RSS链接，并添加到收割机
   ...
   ![RSS 信息填写](https://img.ptools.fun/blog/RSS%20%E4%BF%A1%E6%81%AF%E5%A1%AB%E5%86%99.jpg)	

2. 导入默认订阅标签，如果没有合适的标签，可以自己手动添加

   <img src="https://img.ptools.fun/blog/%E5%AF%BC%E5%85%A5%E8%AE%A2%E9%98%85%E6%A0%87%E7%AD%BE.jpg" alt="导入订阅标签" style="zoom:67%;" />	

3. 添加订阅

   <img src="https://img.ptools.fun/blog/%E6%B7%BB%E5%8A%A0%E8%AE%A2%E9%98%85%201.jpg" alt="添加订阅 1" width=700/>	

4. 选择当前订阅要使用的订阅标签

   <img src="https://img.ptools.fun/blog/%E6%B7%BB%E5%8A%A0%E8%AE%A2%E9%98%85%202.jpg" width=700/>	

5. 添加RSS扫描任务


​	
​	   <img src="https://img.ptools.fun/blog/%E6%B7%BB%E5%8A%A0%E8%AE%A2%E9%98%85%203.jpg" width=600/>	

## 站点信息详解

​	<img src="https://img.ptools.fun/blog/image-20241126203928526.png" alt="站点列表详解" style="zoom: 40%;" />

<img src="https://img.ptools.fun/blog/image-20250718234615502.png" style="zoom: 50%;" />	
	

	![](https://img.ptools.fun/blog/image-20250617204036432.png)	
	...
	![](https://img.ptools.fun/blog/image-20250617204232770.png)	
	
	![image-20250617204607366](https://img.ptools.fun/blog/image-20250617204607366.png)	
	
	![](https://img.ptools.fun/blog/image-20250617204446195.png)	
	
	![image-20250617204406053](https://img.ptools.fun/blog/image-20250617204406053.png)	

## 用户管理

### 添加用户

​	<img src="https://img.ptools.fun/blog/image-20241107222246531.png" alt="image-20241107222246531" style="zoom:33%;" />	
​	
...
<img src="https://img.ptools.fun/blog/image-20241107222400408.png" alt="image-20241107222400408" style="zoom: 33%;" />		
...
![image-20241126202616242](https://img.ptools.fun/blog/image-20241126202616242.png)		

#### 1. 先决条件：当前用户要可以直接运行 docker 命令

   如果不能运行，可以参考一下内容

   [文章直达](https://ptools.fun/zh/%E6%94%B6%E5%89%B2%E6%9C%BA/ssh)
